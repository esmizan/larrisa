...
if ( !class_exists( 'RDTheme_VC_Text_With_Video' ) ) {
	...
	class RDTheme_VC_Text_With_Video extends RDTheme_VC_Modules {
		...
		public function __construct(){
			$this->name = __( "Miako: Text with Video", 'miako-core' );
			$this->base = 'miako-vc-text-with-video';
			$this->translate = array(
				'sm_title'   	    => __( 'Since 1996', 'miako-core' ),
				'lg_title'   	    => __( 'Our Company History', 'miako-core' ),
			);
			parent::__construct();
		}
		...
		public function fields(){
			$fields = array(
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Small Title", 'miako-core' ),
					"param_name" => "sm_title",
				...
				array(
					"type" 		  => "colorpicker",
					"class" 	  => "",
					"heading" 	  => __( "Small Title Color", "miako-core" ),
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Main Title", 'miako-core' ),
					"param_name" => "lg_title",
				...
				array(
					"type" 		  => "colorpicker",
					"class" 	  => "",
					"heading" 	  => __( "Main Title Color", "miako-core" ),
					"param_name"  => "lg_title_color",
					"value" 	  => '#000000',
					),
				array(
					'type' => 'textfield',
					'heading' => __( 'Video link', 'miako-core' ),
					'param_name' => 'link',
					'value' => 'https://vimeo.com/51589652',
					'admin_label' => true,
					'description' => sprintf( __( 'Enter link to video (Note: read more about available formats at WordPress <a href="%s" target="_blank">codex page</a>).', 'miako-core' ), 'http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F' ),
				),
				array(
					"type" 		 => "textarea_html",
					"holder" 	 => "div",
