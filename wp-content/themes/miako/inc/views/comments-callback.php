...
<div id="respond-<?php comment_ID(); ?>" class="each-comment">
	...
	<div class="media-body comments-body">
		<div class="comment-meta">
			...
			?>
			<div class="comment-author-name"><?php echo get_comment_author_link( $comment );?></div>
			<div class="comment-time"><?php printf( __( '%1$s @ %2$s', 'miako' ), get_comment_date( '', $comment ), get_comment_time() );?></div>
		...
		<div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
				<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'miako' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>
		</div>			
	</div>
