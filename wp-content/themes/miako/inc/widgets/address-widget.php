...
class RDTheme_Address_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            ...
            __( 'Miako  : Address (for footer)', 'miako' ), // Name
            array( 'description' => __( 'Address Widget', 'miako' ) ) // Args
            );
	}
	...
	public function widget( $args, $instance ){
		...
		<ul class="corporate-address">
			...
			if( !empty( $instance['phone'] ) ){
				?><li><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_html( $instance['phone'] ); ?></li><?php
			}   
	...
	public function form( $instance ){
		$defaults = array(
			'title'   => __( 'Corporate Office' , 'miako' ),
			'weekday' => '',
			'address' => '',
			'phone'   => '',
			'email'   => '',
		...
		$fields = array(
			...
			'weekday'   => array(
				'label' => esc_html__( 'Working Time', 'miako' ),
				'type'  => 'text',
				),
			'address'   => array(
				'label' => esc_html__( 'Address', 'miako' ),
				'type'  => 'text',
				),      
			'phone'     => array(
				'label' => esc_html__( 'Phone Number', 'miako' ),
				'type'  => 'text',
				),      
			'email'     => array(
				'label' => esc_html__( 'Email', 'miako' ),
				'type'  => 'text',
				),      
			'fax'       => array(
				'label' => esc_html__( 'Fax', 'miako' ),
				'type'  => 'text',
				),
			);
