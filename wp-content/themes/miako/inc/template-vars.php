...
if( !function_exists( 'rdtheme_template_vars' ) ) {
    function rdtheme_template_vars() {
        ...
        if( is_single() || is_page() ) {
            ...
            $layout         = get_post_meta( $post_id, 'miako_layout', true );
            $tr_header      = get_post_meta( $post_id, 'miako_tr_header', true );
            $top_bar        = get_post_meta( $post_id, 'miako_top_bar', true );
            $top_bar_style  = get_post_meta( $post_id, 'miako_top_bar_style', true );
            $header_style   = get_post_meta( $post_id, 'miako_header', true );
            $padding_top    = get_post_meta( $post_id, 'miako_top_padding', true );
            $padding_bottom = get_post_meta( $post_id, 'miako_bottom_padding', true );
            $has_banner     = get_post_meta( $post_id, 'miako_banner', true );
            $has_breadcrumb = get_post_meta( $post_id, 'miako_breadcrumb', true );
            $bgtype         = get_post_meta( $post_id, 'miako_banner_type', true );
            $bgcolor        = get_post_meta( $post_id, 'miako_banner_bgcolor', true );
            $bgimg          = get_post_meta( $post_id, 'miako_banner_bgimg', true );
